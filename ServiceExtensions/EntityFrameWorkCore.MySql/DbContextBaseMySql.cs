...
{
    /// <summary>
    /// dbcontext for mysql connection which implements methods in IDbContextMySql
    /// </summary>
    public abstract class DbContextBaseMySql : DbContext, IDbContextMySql
    {
        protected readonly ICurrentUserAccessor _currentUserAccessor;

        protected DbContextBaseMySql(DbContextOptions options,ICurrentUserAccessor currentUserAccessor)
            :base(options)
        {
            _currentUserAccessor = currentUserAccessor;
        } 

        public Task<int> ExecuteNonQueryProcCommandAsync(string proc, params MySqlParameter[] parameters)
        {
        ...
        public Task<DbDataReader> ExecuteReaderProcCommandAsync(string proc, params MySqlParameter[] parameters)
        {
        ...
        internal DbCommand PrepareProcCommand(string proc,params MySqlParameter[] parameters)
        {
